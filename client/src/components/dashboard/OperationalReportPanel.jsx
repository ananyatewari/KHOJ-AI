...
export default function OperationalReportPanel({
  ...
  return (
    <section className="mb-12 bg-slate-950/60 border border-white/10 rounded-2xl p-6 backdrop-blur-xl">
      {/* HEADER */}
      ...
      {report && (
        <>
          ...
          <div className="mb-8">
            ...
            <div className="h-64 bg-slate-900/60 rounded-xl p-4 border border-white/10">
