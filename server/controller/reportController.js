...
export const exportOperationalPDF = async (req, res) => {
  try {
    ...
    doc
      .fontSize(10)
      .fillColor("#374151")
      .text(`Agency: ${req.user.agency.toUpperCase()}`, { align: "center" })
...
`;
    ...
    doc
      ...
      .fontSize(8)
      .fillColor("#6B7280")
      .text("Intelligence Platform | Secure Document Analysis", { align: "center" });
    ...
    doc
      ...
      .fillColor("#9CA3AF")
      .text(
        "This report is confidential and generated for authorized personnel only.",
        { align: "center" }
      );
